Public Class Form1
    ...
    Private Sub BTN_Ok_Click(sender As Object, e As EventArgs) Handles BTN_Ok.Click
        ' Variables
        Dim pAtt, pCP, pQuiz, pExam, TotalPrelimGrade As Double
        Dim mAtt, mCP, mQuiz, mExam, TotalMidtermGrade As Double
        Dim fAtt, fCP, fQuiz, fExam, TotalFinalGrade As Double
        ...
        TotalPrelimGrade = pAtt * 0.05 + pCP * 0.15 + pQuiz * 0.3 + pExam * 0.5
        ...
        TotalMidtermGrade = mAtt * 0.05 + mCP * 0.15 + mQuiz * 0.3 + mExam * 0.5
        ...
        TotalFinalGrade = fAtt * 0.05 + fCP * 0.15 + fQuiz * 0.3 + fExam * 0.5
